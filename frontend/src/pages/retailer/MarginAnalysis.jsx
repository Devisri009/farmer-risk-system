...
const MarginAnalysis = () => {
    // Mock Data
    const margins = [
        { id: 1, crop: "Organic Carrots", buyPrice: 2.06, marketPrice: 3.50, margin: 70, trend: 'up' },
        { id: 2, crop: "Almonds", buyPrice: 11.00, marketPrice: 15.00, margin: 36, trend: 'up' },
        { id: 3, crop: "Tomatoes", buyPrice: 1.50, marketPrice: 1.40, margin: -6, trend: 'down' },
        { id: 4, crop: "Potatoes", buyPrice: 0.80, marketPrice: 1.20, margin: 50, trend: 'up' }
    ];
        ...
        <div className="space-y-6">
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-500">Track profitability and current market values of your inventory.</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col h-full">
                    <h2 className="text-lg font-bold text-gray-900 mb-6">Profitability by Item</h2>
